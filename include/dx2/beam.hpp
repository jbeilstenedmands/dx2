...
// full constructor
inline BeamBase::BeamBase(Vector3d direction, double divergence,
                   double sigma_divergence, Vector3d polarization_normal,
                   double polarization_fraction, double flux,
                   double transmission, double sample_to_source_distance)
...
inline void BeamBase::init_from_json(json beam_data) {
...
inline void BeamBase::add_to_json(json &beam_data) const {
...
inline Vector3d BeamBase::get_polarization_normal() const {
...
// full constructor
inline MonochromaticBeam::MonochromaticBeam(double wavelength, Vector3d direction,
                                     double divergence, double sigma_divergence,
...
inline MonochromaticBeam::MonochromaticBeam(double wavelength)
    : wavelength_{wavelength} {}

inline MonochromaticBeam::MonochromaticBeam(Vector3d s0) {
  double len = s0.norm();
  wavelength_ = 1.0 / len;
...
inline MonochromaticBeam::MonochromaticBeam(json beam_data) {
...
inline json MonochromaticBeam::to_json(std::string probe = "x-ray") const {
...
inline double MonochromaticBeam::get_wavelength() const { return wavelength_; }
inline void MonochromaticBeam::set_wavelength(double wavelength) {
  wavelength_ = wavelength;
}

inline Vector3d MonochromaticBeam::get_s0() const {
  return -sample_to_source_direction_ / wavelength_;
}
inline void MonochromaticBeam::set_s0(const Vector3d s0) {
  double len = s0.norm();
  wavelength_ = 1.0 / len;
  sample_to_source_direction_ = -1.0 * s0 / len;
}
...
// full constructor
inline PolychromaticBeam::PolychromaticBeam(std::array<double, 2> wavelength_range,
...
// constructor from json data
inline PolychromaticBeam::PolychromaticBeam(json beam_data) {
  // minimal required keys
...
// serialize to json format
inline json PolychromaticBeam::to_json(std::string probe = "x-ray") const {
  // create a json object that conforms to a dials model serialization.
...
inline std::array<double, 2> PolychromaticBeam::get_wavelength_range() const {
  return wavelength_range_;
}
inline void PolychromaticBeam::set_wavelength_range(
...
inline json MonoXrayBeam::to_json() const {
...
inline json MonoElectronBeam::to_json() const {
